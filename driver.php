                ...
                <div class="row">
                    <div class="navbar-header">
                        ...
                        <div class="logo-wrapper">
                            <a class="navbar-brand" href="index.php">                                <em>AND</em>
...
(adsbygoogle = window.adsbygoogle || []).push({});
        ...
        <div class="container">
            ...
            <div class="col-lg-12 " >
             <strong  style="text-align:center;font-size:30px;color:black; margin-top: -60px;">DRIVERS(coming soon)</strong>
            </div>
                <div class="col-lg-3 col-md-4 col-sm-6 c">
               <a href="#" class="thumbnail">
                <p>DRIVER 1</p>
                  <img src="photos/d1.jpg"style="height:200px;width:260px;" >
                  </a>
                      <form action="2.php" method="post">
                
              <input type="hidden" name="username" value="driver1">
              <button class = "btn btn-primary" type="submit" style="margin-bottom:18px;">DETAILS</button>
                 ...
                 <div class="col-lg-3 col-md-4 col-sm-6 c">
                    <a href="#" class="thumbnail">
                    <p>DRIVER 2</p>
                    <img src="photos/d2.jpg" style="height:200px;width:260px;">
                  </a>
               <form action="2.php" method="post">
                
              <input type="hidden" name="username" value="driver2">
              <button class = "btn btn-primary" type="submit" style="margin-bottom:18px;">DETAILS</button>
                 </form>
                  </div>
                  </div>
