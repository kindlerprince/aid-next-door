...
(adsbygoogle = window.adsbygoogle || []).push({});
        ...
        <div class="container">
            ...
            <div class="col-lg-12 " >
             <strong  style="text-align:center;font-size:30px;color:black; margin-top: -60px;">MAID(coming soon)</strong>
            </div>
                <div class="col-lg-3 col-md-4 col-sm-6 c">
                  <a href="2.php" class="thumbnail">
                  <p>MAID 1</p>
                  <img src="photos/m1.jpg"style="height:200px;width:260px;" >
                  </a>
                   <form action="2.php" method="post">
                
              <input type="hidden" name="username" value="maid1">
              <button class = "btn btn-primary" type="submit" style="margin-bottom:18px;">DETAILS</button>
                 ...
                 <div class="col-lg-3 col-md-4 col-sm-6 c">
                    <a href="2.php" class="thumbnail">
                    <p>MAID 2</p>
                    <img src="photos/m2.jpg" style="height:200px;width:260px;">
                  </a>
                   <form action="2.php" method="post">
                
              <input type="hidden" name="username" value="maid2">
              <button class = "btn btn-primary" type="submit" style="margin-bottom:18px;">DETAILS</button>
                 </form>
                  </div>
                  </div>
